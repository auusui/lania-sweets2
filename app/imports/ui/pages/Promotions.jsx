...
class Promotions extends React.Component {
  render() {
    return (
        <Header className="page-headers" as='h1'>PROMOTIONS</Header>,
        <Header className="page-headers" as='h2'>Here you will find promotions the owner gives periodically.</Header>,
